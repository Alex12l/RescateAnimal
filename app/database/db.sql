...
VALUES
 ('Macho', 'Saludable', 'Completa', 'Disponible', '2024-01-15', 'labrador.png'),
('Adulto', 'Luna', 'Gato', 'Siames', 'Hembra', 'Alergias leves', 'Completa('Cachorro', 'Max', 'Perro', 'Labrador',', 'Adoptado', '2023-11-20', 'luna.png'),
('Senior', 'Rocky', 'Perro', 'Bulldog', 'Macho', 'Artritis', 'Parcial', 'En tratamiento', '2022-05-10','rocky.png'),
('Discapacitado', 'Mimi', 'Gato', 'Persa', 'Hembra', 'Ceguera parcial', 'Completa', 'Disponible', '2024-03-05','persa.png');
